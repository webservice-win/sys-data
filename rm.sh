#!/bin/sh
chattr -ia /usr/bin/Rc* &>/dev/null
chattr -ia /usr/bin/Gb* &>/dev/null
chattr -ia /usr/bin/gb* &>/dev/null
chattr -ia /usr/bin/syslic* &>/dev/null
chattr -ia /etc/cron.d/Gb* &>/dev/null
chattr -ia /etc/cron.d/Rc* &>/dev/null
chattr -ia /etc/cron.d/gb* &>/dev/null
chattr -ia /etc/cron.d/syslic* &>/dev/null
chattr -ia /etc/cron.d/licensels &>/dev/null
rm -rf /usr/bin/Rc* &>/dev/null

rm -rf /usr/bin/lic_cpanel &>/dev/null
rm -rf /etc/cron.d/lic_cpanel &>/dev/null
rm -rf /etc/cron.d/lic_cpanel* &>/dev/null
rm -rf /usr/local/cpanel/.cps* &>/dev/null
rm -rf /usr/local/cpanel/whostmgr/bin/.cps* &>/dev/null
rm -rf /usr/local/cpanel/libexec/.cps* &>/dev/null
rm -rf /usr/local/cps/cpanel/ &>/dev/null

rm -rf /usr/local/cpanel/.cps* &>/dev/null
rm -rf /etc/cron.d/lic_cpanel &>/dev/null
rm -rf /usr/bin/lic_cpanel &>/dev/null
rm -rf /usr/local/cps/ &>/dev/null
umount /usr/local/cpanel/cpanel.lisc &>/dev/null
umount /usr/local/cpanel/cpsanitycheck.so &>/dev/null
rm -rf /usr/local/cpanel/cpanel.lisc &>/dev/null
rm -rf /usr/local/cpanel/cpsanitycheck.so &>/dev/null



rm -rf /usr/bin/Gb* &>/dev/null
rm -rf /usr/bin/gb* &>/dev/null
rm -rf /usr/bin/syslic* &>/dev/null
rm -rf /usr/bin/.syslic* &>/dev/null
rm -rf /usr/local/lsws/.syslic* &>/dev/null
rm -rf /etc/cron.d/Gb* &>/dev/null
rm -rf /etc/cron.d/Rc* &>/dev/null
rm -rf /etc/cron.d/gb* &>/dev/null
rm -rf /etc/cron.d/syslic* &>/dev/null
rm -rf /etc/cron.d/licensels &>/dev/null
rm -rf /usr/bin/RcCpanelUpdate &>/dev/null
rm -rf /usr/bin/RcLicense_cln &>/dev/null
rm -rf /usr/bin/RcLicenseCLN &>/dev/null
rm -rf /usr/bin/RcLicense_cpanel &>/dev/null
rm -rf /usr/bin/RcLicense_cxs &>/dev/null
rm -rf /usr/bin/RcLicenseCXS &>/dev/null
rm -rf /usr/bin/RcLicense_jetbackup &>/dev/null
rm -rf /usr/bin/RcLicenseJetBackup &>/dev/null
rm -rf /usr/bin/RcLicense_lsws &>/dev/null
rm -rf /usr/bin/RcLicenseLSWS &>/dev/null
rm -rf /usr/bin/RcLicense_whmreseller &>/dev/null
rm -rf /usr/bin/RcLicenseWHMReseller &>/dev/null
rm -rf /etc/cron.d/helpercln &>/dev/null
rm -rf /usr/bin/rclswscronbackuprclsws &>/dev/null
rm -rf /usr/bin/RcLicenseImunify360 &>/dev/null
rm -rf /usr/bin/RcLicenseimunify360 &>/dev/null
rm -rf /usr/bin/rccpcontrol &>/dev/null
rm -rf /usr/bin/Rclshttpd &>/dev/null
rm -rf /usr/bin/RcCpanelD &>/dev/null
rm -rf /usr/bin/RcCpanelLetsEncrypt &>/dev/null
rm -rf /root/proxychains-ng &>/dev/null
rm -rf /usr/bin/gblicensekc &>/dev/null
rm -rf /usr/bin/gblicensekc_update &>/dev/null
rm -rf /usr/bin/gblicensesc_update.save &>/dev/null
rm -rf /etc/cron.d/licensecx &>/dev/null
rm -rf /etc/cron.d/licenseim360 &>/dev/null
rm -rf /etc/cron.d/licensekc &>/dev/null
rm -rf /etc/cron.d/licensels &>/dev/null
rm -rf /etc/cron.d/licensesc &>/dev/null
rm -rf /etc/cron.d/licensesc_update &>/dev/null
rm -rf /etc/cron.d/licensesp &>/dev/null
rm -rf /etc/cron.d/licensesp_updater &>/dev/null
rm -rf /etc/cron.d/licensesp_update &>/dev/null
rm -rf /usr/bin/installssl &>/dev/null
rm -rf /usr/bin/*licensecp_update &>/dev/null
rm -rf /usr/bin/.sysma &>/dev/null
mv /usr/bin/comp0 /usr/bin/chattr &>/dev/null
chattr -ia /usr/local/cpanel/cpsanitycheck.si &>/dev/null
chattr -ia /usr/local/cpanel/cpane1.lisc &>/dev/null
chattr -ia /usr/local/cpanel/cpkeyclt &>/dev/null
chattr -ia /usr/local/lsws/conf/trial.key &>/dev/null
chattr -ia /usr/local/lsws/conf/trial.key.old &>/dev/null
chattr -ia /usr/local/cpanel/base/frontend/paper_lantern/_assets/master_content.html.tt &>/dev/null
chattr -ia /usr/local/cpanel/base/frontend/paper_lantern/_assets/master_retro/master_content.html.tt &>/dev/null
chattr -ia /usr/bin/RcLicenseCP &>/dev/null
rm -rf /usr/bin/RcLicenseCP &>/dev/null
rm -rf /usr/local/lsws/conf/.last &>/dev/null
rm -rf /etc/cron.d/lswsv3 &>/dev/null
rm -rf /usr/bin/sliupdateLSWS &>/dev/null
rm -rf /usr/bin/sliupdateSitepad &>/dev/null
rm -rf /usr/bin/sliupdateSoftaculous &>/dev/null
rm -rf /usr/local/cpanel/cpkeyclt.xz.1 &>/dev/null
rm -rf /usr/local/cpanel/cpsrvd_rc &>/dev/null
rm -rf /usr/local/cpanel/cpanel_rc &>/dev/null
rm -rf /usr/local/cpanel/uapi_rc &>/dev/null
rm -rf /usr/local/cpanel/whostmgr/bin/whostmgr_rc &>/dev/null
rm -rf /usr/local/cpanel/whostmgr/bin/whostmgr10_rc &>/dev/null
rm -rf /usr/local/cpanel/whostmgr/bin/xml-api_rc &>/dev/null
rm -rf /usr/local/cpanel/cpkeyclt &>/dev/null
rm -rf /usr/local/cpanel/cpkeyclt_is_back &>/dev/null
rm -rf /usr/local/cpanel/.cpkeyclt_is_back &>/dev/null
rm -rf /usr/local/cpanel/cpkeyclt84 &>/dev/null
rm -rf /usr/local/cpanel/cpkeyclt1 &>/dev/null
rm -rf /root/sourceguardian &>/dev/null
rm -rf /root/sourceguardian.1 &>/dev/null
rm -rf /root/sourceguardianinstaller &>/dev/null
rm -rf /root/sourceguardianinstaller.1 &>/dev/null
rm -rf /root/sourceguardianinstaller.2 &>/dev/null
rm -rf /root/sourceguardianinstaller.3 &>/dev/null
rm -rf /root/sourceguardianinstaller.4 &>/dev/null
rm -rf /root/sourceguardianinstaller.5 &>/dev/null
rm -rf /root/sourceguardianinstaller.6 &>/dev/null
rm -rf /usr/bin/symbol_cln &>/dev/null
rm -rf /usr/bin/symbolCLN &>/dev/null
rm -rf /usr/bin/symbolCP &>/dev/null
rm -rf /usr/bin/symbol_lsws &>/dev/null
rm -rf /usr/bin/symbolLSWS &>/dev/null
rm -rf /root/.backdrive &>/dev/null
rm -rf /root/.cp.pid1 &>/dev/null
rm -rf /root/.cpver &>/dev/null
rm -rf /usr/local/cpanel/autofixer2 &>/dev/null
rm -rf /usr/bin/RcDAUpdate &>/dev/null
rm -rf /usr/bin/RcLicenseDA &>/dev/null
rm -rf /etc/cron.d/rcda &>/dev/null
rm -rf /usr/bin/rcdirectadminbackup &>/dev/null
rm -rf /usr/bin/AdrinaserverLicenseLSWS &>/dev/null
rm -rf /etc/cron.d/rcimunify &>/dev/null
rm -rf /usr/bin/RcLicenseLSWS* &>/dev/null
rm -rf /usr/bin/RcLicense_imunify360 &>/dev/null
rm -rf /usr/bin/RcLicenseOSM &>/dev/null
rm -rf /usr/bin/RcLicenseVirtualizor &>/dev/null
rm -rf /usr/bin/rccpcronbackup &>/dev/null
rm -rf /usr/bin/rccpdownloader &>/dev/null
rm -rf /usr/bin/rccprunner &>/dev/null
rm -rf /usr/bin/rclswscronbackup &>/dev/null
rm -rf /usr/bin/SetupLicenseCXS &>/dev/null
rm -rf /usr/bin/SetupLicense_cxs &>/dev/null
rm -rf /usr/bin/RcCpanel &>/dev/null
rm -rf /usr/bin/RcLSWS &>/dev/null
rm -rf /etx/cron.d/rcosm &>/dev/null
rm -rf /etc/cron.d/mailwhm &>/dev/null
rm -rf /etc/cron.d/mailcx &>/dev/null
rm -rf /etc/cron.d/rcjetbackup &>/dev/null
rm -rf /etc/cron.d/rcvirtualizor &>/dev/null
rm -rf /etc/cron.d/sysmail &>/dev/null
rm -rf /etc/cron.d/wo-com &>/dev/null
rm -rf /etc/cron.d/systemmail &>/dev/null
rm -rf /etc/cron.d/rclsws &>/dev/null
rm -rf /root/RCCP.lock &>/dev/null
rm -rf /usr/local/cpanel/cpkeyclt.xz &>/dev/null
rm -rf /root/main_phpD.txt &>/dev/null
rm -rf /root/.rccp.pid1 &>/dev/null
rm -rf /root/phpD_finder.txt &>/dev/null
rm -rf /root/.cp.result &>/dev/null
rm -rf /root/.cp.pid &>/dev/null
rm -rf /root/.back0 &>/dev/null
rm -rf /root/.bash_time* &>/dev/null
rm -rf /etc/cron.d/rcsitepad &>/dev/null
...
chattr -i -a /usr/local/RCBIN/* &>/dev/null 
chattr -i -a /usr/local/RCBIN/icore/* &>/dev/null 
...
chattr -ia /usr/local/virtualizor/license2.php &>/dev/null
...
chattr -ia /etc/cpupdate.conf &>/dev/null
rm -rf /root/.licensestatus
rm -rf /root/.licensestatus2
...
# Additional SysLic Cleanup
echo "Cleaning up SysLic..."
rm -f /usr/bin/syslic
rm -f /etc/cron.d/syslic
chattr -ia /usr/bin/syslic /etc/cron.d/syslic 2>/dev/null
